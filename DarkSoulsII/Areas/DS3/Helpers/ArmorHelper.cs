...
namespace DarkSoulsII.Areas.DS3.Helpers
{
    public class ArmorHelper
    {
                                                         ...
                                                         double? minPoise = null)
        {
            using (var lifetime = IoC.Container.BeginLifetimeScope())
            {
                using (var unit = lifetime.Resolve<IUnitOfWork>())
                {
                    ...
                    string query = "Exec [DS3].[ArmorSearch] @SearchValue, @ArmorId, @ArmorTypeId, @MaxWeight, @MinPoise";
        ...
        {
            IEnumerable<ArmorType> armorTypes = _cache.GetDS3ArmorTypes();
        ...
        {
            IEnumerable<Armor> armors = _cache.GetDS3Armor();
